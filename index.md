...
- **interpersonal interaction** — how body motion reveals leadership, emotion, and connection during multipersonal joint music performance, conversation, and dating <3.
- **machine learning/ai** — interpretable and/or multimodal machine learning with neuroscientific and cognitive inspirations (or not).
- **research methods** — exploring freely to find the mathematically sound, just-slightly-more-than-enough approach to serve the research need.
</section>
