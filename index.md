...
- **interpersonal interaction** — how dynamic vocal, facial, and body behavior reveal leadership, emotion, and connection during multipersonal joint music performance, conversation, videoconferencing, and dating <3.
- **ml/ai** — multimodal and interpretable machine learning with an audio focus, with neuroscientific and cognitive inspirations (if possible).
- **research methods** — exploring ad libitum to find the mathematically sound and just-slightly-more-than-enough approach to serve the research need.
</section>
...
<ul class="cv">
  <li><span class="date">2025–</span><span><strong>Senior Quantitative UX Researcher</strong>, Google</span></li>
  <li><span class="date">2020–25</span><span><strong>Postdoctoral Researcher</strong>, New York University</span></li>
  <li><span class="date">2014–19</span><span><strong>PhD in Psychology</strong>, McMaster University</span></li>
  <li><span class="date">2008–13</span><span><strong>BS in Psychology</strong>, National Taiwan University</span></li>
</ul>
</section>
